...
module.exports = {
    ...
    routes: {
        ...
        "POST api/user/register": { path: 'post/api/user/register/data', id: 159723, group: 'user' },
        "POST /api/user/auth": { path: 'post/api/user/auth/data', id: 159731, group: 'user' },
    },
    /* 注入给页面的模型数据的服务器配置 */
    // modelServer: {
    //     // 完整的主机地址，包括协议、主机名、端口
    ...
    /* 项目的 key */
    projectKey: '96aaab0e7720d1325228050e3b9284ca',
    /* 同步模块mock数据路径 */
    mockTpl: '',
    /* 异步接口mock数据路径 */
    mockApi: 'D:/1毕业设计/sextant/mock/api/',
    /* 是否修改代理的host */
    changeOrigin: true,
    /* 模板后缀 */
    viewExt: '.ejs',
